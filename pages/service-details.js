                    ...
                    <div className="container">
                        <div className="row align-items-center">
                            ...
                            <div className="col-lg-6 services-details-image">
                                <img src={require("../images/services-details-image/1.png")} className="wow fadeInUp" alt="image" />
                            </div>
                        </div>
                        ...
                        <div className="row align-items-center">
                            <div className="col-lg-6 services-details-image">
                                <img src={require("../images/services-details-image/2.png")} className="wow fadeInUp" alt="image" />
                            </div>
